    ...
    protected void GenerateStage() {
        thisStage = new Stage(
                new Event[]{
                        ...
                        new Event(Events.BreakdownCoolantPump, 10.0, "We make the best, most reliable, and heaviest pumps. No one makes heavier pumps!", MessageTextures.Leader),
                        new Event(Events.CoolantLeak, 15.0, "Coolant levels are dropping again, the pipe must be leaking", MessageTextures.Player),
                        new Event(Events.BreakdownWaterPump, 20.0, "Any rumours about our pumps being unreliable is unprovable slander!", MessageTextures.Leader),
                        ...
                        new Event(Events.BreakdownHeatExchange, 30.0, "Heat Exchangers? I'm not sure what they are. " +
                                "\n\nBut I bet we manufacture the best, cleanest heat exchangers in the world!", MessageTextures.Leader),
                        new Event(Events.BreakdownCoolantPump, 35.0, "Power levels are dropping, better check the coolant pump.", MessageTextures.Player),
                        new Event(Events.CoolantLeak, 40.0, "Sounds like I'll be getting wet feet again.", MessageTextures.Player),
                        new Event(Events.BreakdownWaterPump, 45.0, "Water pump breakdown, this is getting ridiculous.", MessageTextures.Player),
                        new Event(Events.MoarPowah, 50.0, "MOOOAAAR POOWAAAAH!!! " +
