...
public class YouWinScreen extends AbstractScreen {
    ...
    public YouWinScreen(IScreenManager screenManager, AssetManager assetManager) {
    ...
    public void show() {
        ...
        titleLabel = new Label("Congratulations! You Win!", uiSkin, "title", Color.WHITE);
    ...
    private void AddEntities() {
        Texture nuclear = assetManager.get("textures/nuclear-night.png", Texture.class);
